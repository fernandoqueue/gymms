<div style="margin-top: 1rem">
                    ...
                    <tbody style="border-top: unset;" >
                        @forelse($admins as $admin)
                            <tr style="background-color:white">
                                <td>
                                    <input type="checkbox" value="{{ $admin->id }}" wire:model.debounce.0ms="selected">
                                </td>
                                <td scope="row">
                                    {{ $admin->id }}
                                </td>
                                ...
                                <td>
                                    <a class="link-light-blue" href="mailto:{{ $admin->email }}">
                                ...
                                <td>
                                    <div style="float:right" class="dropstart btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" wire:click="confirm('delete', {{ $admin->id }})" wire:loading.attr="disabled" href="#">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
    ...
    <div class="row" style="margin-top: .4rem">
        ...
        <div class="col-6">
            <div style="float: right;">
                {{ $admins->links('livewire.components.simple-pagination') }}
            </div>
        </div>
    </div>
